...
def main(
    ...
    for key, values in dataset_info_dict.items():
        ...
        if 'align' in key:
            ...
            url_file = '/mnt/pfs_l2/jieti_team/SFT/hupeng/data/en/open_pa/test/mos_url.list'    # 可以根据需要设置URL文件路径
            get_open_pa_res(values, dataset_name, logger, output_csv, url_file)
        else:
...
if __name__ == "__main__":
    ...
    infer_res_file = '/mnt/pfs_l2/jieti_team/SFT/hupeng/resources/PaMLLM/PaMLLM_kimi_v2.5/model_infer/infer_res/infer_xxj_compare_v2_test.json'
